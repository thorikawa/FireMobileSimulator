...
firemobilesimulator.mpc.ezweb.prototype = {
  ...
  e_options_encode : function(iconno) {
    ...
    return this.getImageSrc(iconno);
  },
  ...
  convertBinary : function(str) {
    // Unicodeバイナリで絵文字に合致する部分をimgタグに変換する
    var a = new Array();
    var r = "";
    var n = str.length;
    for (var i=0; i<n; i++) {
      ...
      var unofficlalSjisDecs = this.e_unofficialUnicode2SJIS(decs);
  ...
  preConvert : function(str) {
    ...
    // Auは、Unicodeの数値参照とSJISの数値参照が混在する可能性があるので注意が必要
  ...
  /**
   * SJISのビット列から裏KDDI Unicodeのビット列に変換する
   */
  e_s2uou : function (bits) {
    var r = new Array(2);
    if (bits.length != 2) {
      return 0;
    }
  ...
  /**
   * 裏KDDI Unicodeのビット列からSJISのビット列に変換する
   */
